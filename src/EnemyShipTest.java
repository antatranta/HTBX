...
public class EnemyShipTest extends GraphicsApplication implements ActionListener {
	...
	public void init() {
		...
		enemy = new EnemyShip(shipPhysXObj, "Enemy_1.png",10, ShipStats.EnemyStats_01(), 1, 10);
		PhysXObject TargetPhysXObj =  new PhysXObject(id, targetVector);
		target1 = new EnemyShip(TargetPhysXObj, "Enemy_2.png",10,ShipStats.EnemyStats_01(), 1, 10);
