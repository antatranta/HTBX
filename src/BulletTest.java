...
public class BulletTest extends GraphicsApplication implements ActionListener {
	...
	public void shoot() {
		...
		GameImage bullet = bulletStore.onShootEvent(1, 1, BulletType.STRAIGHT, CollisionType.enemy_bullet, 1000, currentLocation, "RedCircle.png", Camera.frontendToBackend(last_mouse_loc), FXManager.redParticle() );
